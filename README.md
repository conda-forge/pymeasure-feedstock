...
<table><tr><td>All platforms:</td>
    <td>
      <a href="https://dev.azure.com/conda-forge/feedstock-builds/_build/latest?definitionId=4771&branchName=main">
        <img src="https://dev.azure.com/conda-forge/feedstock-builds/_apis/build/status/pymeasure-feedstock?branchName=main">
      </a>
    </td>
  </tr>
</table>
...
Once the `conda-forge` channel has been enabled, `pymeasure` can be installed with `conda`:
...
```
mamba install pymeasure
```

It is possible to list all of the versions of `pymeasure` available on your platform with `conda`:
...
```
mamba search pymeasure --channel conda-forge
```
...
mamba repoquery search pymeasure --channel conda-forge

# List packages depending on `pymeasure`:
mamba repoquery whoneeds pymeasure --channel conda-forge

# List dependencies of `pymeasure`:
mamba repoquery depends pymeasure --channel conda-forge
```
